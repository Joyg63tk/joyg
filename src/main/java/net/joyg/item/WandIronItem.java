...
import net.joyg.procedures.WandIronOnPlayerStoppedUsingProcedure;

import java.util.List;

public class WandIronItem extends Item {
	public WandIronItem() {
	...
	public void releaseUsing(ItemStack itemstack, Level world, LivingEntity entity, int time) {
		WandIronOnPlayerStoppedUsingProcedure.execute(entity, itemstack);
	}
}
