...
public class TotemFrostshamanItem extends Item {
	public TotemFrostshamanItem() {
	...
	public void appendHoverText(ItemStack itemstack, Level level, List<Component> list, TooltipFlag flag) {
		...
		list.add(Component.literal("While you have Idolatry passive alocated: Totems you summon cast Icicle instead"));
	}
}
