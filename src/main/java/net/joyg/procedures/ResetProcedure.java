	...
	public static void execute(LevelAccessor world, double x, double y, double z, CommandContext<CommandSourceStack> arguments) {
		if (((new Object() {
			...
			if ((new Object() {
				...
				}.getEntity()).getCapability(JoygModVariables.PLAYER_VARIABLES_CAPABILITY, null).orElse(new JoygModVariables.PlayerVariables())).level * 0.5)));
			...
			if ((new Object() {
				...
				_player.displayClientMessage(Component.literal("No tienes suficientes Niveles para Reiniciar tus Passivos"), false);
			if ((new Object() {
				public Entity getEntity() {
					try {
						return EntityArgument.getEntity(arguments, "name");
				...
				_player.displayClientMessage(Component.literal("No tienes suficientes Niveles para Reiniciar tus Passivos"), true);
		}
	}
}
