...
public class BHammerEntity extends Monster implements GeoEntity {
	...
	public static final EntityDataAccessor<Integer> DATA_age = SynchedEntityData.defineId(BHammerEntity.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Integer> DATA_damage = SynchedEntityData.defineId(BHammerEntity.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Integer> DATA_damageCD = SynchedEntityData.defineId(BHammerEntity.class, EntityDataSerializers.INT);
	...
	public BHammerEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(JoygModEntities.B_HAMMER.get(), world);
	}
	...
	public void addAdditionalSaveData(CompoundTag compound) {
		...
		compound.putInt("DatadamageCD", this.entityData.get(DATA_damageCD));
	}
	...
	public void readAdditionalSaveData(CompoundTag compound) {
		...
		if (compound.contains("DatadamageCD"))
			this.entityData.set(DATA_damageCD, compound.getInt("DatadamageCD"));
	}

	@Override
	public void baseTick() {
		super.baseTick();
		BHammerOnEntityTickUpdateProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
	...
	private PlayState movementPredicate(AnimationState event) {
		if (this.animationprocedure.equals("empty")) {
			return event.setAndContinue(RawAnimation.begin().thenLoop("animation.model.blesshammer"));
		}
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 20) {
			this.remove(BHammerEntity.RemovalReason.KILLED);
			this.dropExperience();
		}
	}
