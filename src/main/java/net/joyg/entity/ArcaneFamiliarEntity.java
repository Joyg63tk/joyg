...
public class ArcaneFamiliarEntity extends TamableAnimal {
	...
	public ArcaneFamiliarEntity(EntityType<ArcaneFamiliarEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(2, new FollowOwnerGoal(this, 3, (float) 5, (float) 1, false));
		...
		this.goalSelector.addGoal(6, new RandomStrollGoal(this, 0.8, 20) {
			...
			protected Vec3 getPosition() {
				RandomSource random = ArcaneFamiliarEntity.this.getRandom();
				double dir_x = ArcaneFamiliarEntity.this.getX() + ((random.nextFloat() * 2 - 1) * 16);
				double dir_y = ArcaneFamiliarEntity.this.getY() + ((random.nextFloat() * 2 - 1) * 16);
				double dir_z = ArcaneFamiliarEntity.this.getZ() + ((random.nextFloat() * 2 - 1) * 16);
	...
	public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
		ArcaneFamiliarEntity retval = JoygModEntities.ARCANE_FAMILIAR.get().create(serverWorld);
