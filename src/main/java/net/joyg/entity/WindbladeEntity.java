...
import net.joyg.procedures.WindbladeOnEntityTickUpdateProcedure;
import net.joyg.procedures.LootbagEEntityIsHurtProcedure;
import net.joyg.init.JoygModEntities;

public class WindbladeEntity extends Monster {
	public static final EntityDataAccessor<Integer> DATA_age = SynchedEntityData.defineId(WindbladeEntity.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Integer> DATA_damage = SynchedEntityData.defineId(WindbladeEntity.class, EntityDataSerializers.INT);

	public WindbladeEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(JoygModEntities.WINDBLADE.get(), world);
	}

	public WindbladeEntity(EntityType<WindbladeEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(1.1f);
		xpReward = 0;
		setNoAi(false);
	...
	public void baseTick() {
		super.baseTick();
		WindbladeOnEntityTickUpdateProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
	}
