...
public class JoygModAttributes {
	...
	public static final RegistryObject<Attribute> MANALEECH = ATTRIBUTES.register("mana_leech", () -> (new RangedAttribute("attribute." + JoygMod.MODID + ".mana_leech", 0, 0, 10)).setSyncable(true));
