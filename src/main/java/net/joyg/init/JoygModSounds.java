...
public class JoygModSounds {
	...
	public static final RegistryObject<SoundEvent> RIGHTEOUS_SAC = REGISTRY.register("righteous_sac", () -> SoundEvent.createVariableRangeEvent(new ResourceLocation("joyg", "righteous_sac")));
}
